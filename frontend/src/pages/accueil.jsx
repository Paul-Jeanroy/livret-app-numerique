    ...
    return (
        ...
        <main>
            ...
            <main className="main-home" style={{ overflowY: f_openPopupHome ? "none" : "" }}>
                {/* Si le rôle de l'utilisateur est MA ou Eleve */}
                <section id="section-home-1">
                    ...
                    <div className="content">
                        ...
                        <p>
                            Votre parcours éducatif mérite un outil moderne et efficace. Avec notre Livret d'Apprentissage Numérique, transformez
                            votre manière d'apprendre et de suivre vos progrès.
                        </p>
                ...
                <section id="section-home-3">
                    <div className="div-partie-gauche">
                        ...
                        <p>
                            Ce livret est un passeport d'apprentissage numérique qui aide les étudiants, les écoles et les entreprises à se connecter
